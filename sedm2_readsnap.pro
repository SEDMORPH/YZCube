...
;;-- gas particles
  if Ngas gt 0 and keyword_set(getgas) then begin
     gas = replicate({x:0.0, y:0.0, z:0.0,vx:0.0, vy:0.0, vz:0.0,mass:0.0, sph_smooth:0.0,sfr:0.0, id:0L, rho:0.0, nh:0.0,ind_vel:0L},Ngas)
...
;;-- Star particles
  if Nstars gt 0 and keyword_Set(getstars) then begin
     stars = replicate({x:0.0, y:0.0, z:0.0, vx:0.0, vy:0.0, vz:0.0, mass:0.0, age:0.0, met:0.0, id:0L,ind_vel:0L, ind_ssp:0L},Nstars) ;ind_ssp added for old stars in buildsed
