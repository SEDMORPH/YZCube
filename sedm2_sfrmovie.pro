...
;;------------------------------------------------------------------
  ...
  for index=0,nsnap-1 do begin
     ...
     plot,sfr_time[select], SFR_tot_Msun_yr_smooth[select],/ylog,yr=minmax(SFR_tot_Msun_yr_smooth[ind],/nan),/xs,xtitle='Time / Gyr',position=pos,color=cgcolor('black'),background=cgcolor('white'),xr=minmax(sfr_time)
